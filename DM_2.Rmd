...
### Correlation Matrix
```{r}
train.nums <- unlist(lapply(all_train, is.numeric))
l.idx <- length(colnames(all_train))

corrplot(cor(all_train[colnames(all_train)[c(1:29,l.idx-2,l.idx)]]),method="color",type="upper")
```


## Elimination of variables
```{r}
# train$prop_starrating
# train$visitor_hist_starrating 
# train$visitor_hist_adr_usd 
# train$price_usd
# train$srch_room_count
# train$srch_booking_window
# train$srch_adults_count
# train$srch_children_count
```
