...
file_training <- file.path(Working_directory, "full_train", "full_train.csv")
...
file_Test <- file.path(Working_directory, "modified_splits", "mod_test.csv")
Test <- read.csv(file_Test, header = TRUE)
...
```{r}
underTrain$starrating_diff <- abs(underTrain$visitor_hist_starrating - underTrain$prop_starrating)
underTrain$usd_diff <- abs(underTrain$visitor_hist_adr_usd - underTrain$price_usd)
underTrain$prop_starrating_monotonic <- abs(underTrain$prop_starrating - mean(underTrain$prop_starrating[underTrain$booking_bool == 1]))
Test$starrating_diff <- abs(Test$visitor_hist_starrating - Test$prop_starrating)
Test$usd_diff <- abs(Test$visitor_hist_adr_usd - Test$price_usd)
